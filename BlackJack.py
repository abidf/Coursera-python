...
def draw(canvas):
    #title
    canvas.draw_text("BlackJack", [200, 300], 30, "Orange")
    #text output
    canvas.draw_text("Dealer", [10, 25], 24, "White")
    canvas.draw_text("Player", [10, 325], 24, "White")
    canvas.draw_text("Player " + str(wins) + ':' + str(loses) + " Dealer", [325, 25], 24, "Yellow")
    canvas.draw_text("Game #" + str(game_no), [325, 45], 18, "White")
    canvas.draw_text(outcome, [100, 325], 20, "Yellow")
    #hands
    dealer_hand.draw(canvas, [100, 50], in_play)
